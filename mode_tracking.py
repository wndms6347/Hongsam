...
def move_mouse():
    ...
    try:
        if gaze.pupils_located:
            ...
            pyautogui.moveTo(screen_width/2 ,
                            screen_height * normalization(gaze.vertical_ratio(),output_eyeratio.loc[8,'v_ratio'],output_eyeratio.loc[4,'v_ratio']) )
            #print(normalization(gaze.vertical_ratio(),output_eyeratio.loc[8,'v_ratio'],output_eyeratio.loc[4,'v_ratio']))
    except:
